...
class Analysis extends CI_Controller {
	...
	public function index()
	{
     ...
     if( $qYear!='' &&  $qMonth!=''){
         for($i=1;$i<=17;$i++){
        $ans[$i]=$this->Analysis_Model->query_associateReport2006($qYear,$qMonth,$qYearEnd,$qMonthEnd,$i)->row()->num;
...
public function EXCELCRMeeting($qDate1,$qDate2)
    {
     ...
     if($d2=='1900-01-01') 
      ...
      $data['d2']=$d2;
       ...
       $data['subpage']="CRmorning";    
        $data['path']="<li>統計報表</li><li  class='break'>&#187;</li>";
        $this->load->view('analysis/EXCELCRMeeting',$data);
    }
   public function EXCELVascularCRMeeting($qDate1,$qDate2)
    {
     ...
     if($d2=='1900-01-01') 
      ...
      $data['d2']=$d2;
       ...
       $data['subpage']="CRmorning";    
        $data['path']="<li>統計報表</li><li  class='break'>&#187;</li>";
        $this->load->view('analysis/EXCELVascularCRMeeting',$data);
    }
...
public function urgency(){
     ...
     if($qYear!="" && $qMonth!=""){
        ...
        $data['a1']=$this->Analysis_Model->query_urgency($qYear,$qMonth,$qYearEnd,$qMonthEnd,'1','0')->row()->num;
     $data['a2']=$this->Analysis_Model->query_urgency($qYear,$qMonth,$qYearEnd,$qMonthEnd,'2','0')->row()->num;
     $data['a3']=$this->Analysis_Model->query_urgency($qYear,$qMonth,$qYearEnd,$qMonthEnd,'3','0')->row()->num;
     $data['a4']=$this->Analysis_Model->query_urgency($qYear,$qMonth,$qYearEnd,$qMonthEnd,'4','0')->row()->num;
     $data['a5']=$this->Analysis_Model->query_urgency($qYear,$qMonth,$qYearEnd,$qMonthEnd,'5','0')->row()->num;
    
     $data['b1']=$this->Analysis_Model->query_euroscore($qYear,$qMonth,$qYearEnd,$qMonthEnd,'1','0')->row()->num;
     $data['b2']=$this->Analysis_Model->query_euroscore($qYear,$qMonth,$qYearEnd,$qMonthEnd,'2','0')->row()->num;
     $data['b3']=$this->Analysis_Model->query_euroscore($qYear,$qMonth,$qYearEnd,$qMonthEnd,'3','0')->row()->num;
     $data['b4']=$this->Analysis_Model->query_euroscore($qYear,$qMonth,$qYearEnd,$qMonthEnd,'4','0')->row()->num;
     $data['b5']=$this->Analysis_Model->query_euroscore($qYear,$qMonth,$qYearEnd,$qMonthEnd,'5','0')->row()->num;
    
      $access_id=accessLog('R','ANALYSIS',$this->session->userdata('userID'),$this->session->userdata('userRealname').'查詢報表【 Urgency and Euroscore II】(期間:'.$qYear.'/'.$qMonth.'~'.$qYearEnd.'/'.$qMonthEnd.')','S');   
     }
        $data['qYear']=$qYear;
     $data['qMonth']=$qMonth;
     $data['qYearEnd']=$qYearEnd;
...
public function euroscore20($qYear='3000',$qMonth='1',$qYearEnd='3000',$qMonthEnd='1',$qType){
        $data['page']="analysis"; 
     $data['subpage']="adult";   
     $ans=null;
     ...
     if($qYear!="" && $qMonth!=""){
        ...
        $ans=$this->Analysis_Model->query_euroscore20($qYear,$qMonth,$qYearEnd,$qMonthEnd,$qType,"0");
      // $ans[9][0]= $ans[$i][0];
     ...
     $data['path']="<li>統計報表</li><li  class='break'>&#187;</li>";
     $this->load->view('analysis/euroscore20',$data);
   }
...
public function association()
    {
     ...
     if( $qYear!='' &&  $qMonth!=''){
         for($i=1;$i<=17;$i++){
        $ans[$i]=$this->Analysis_Model->query_associateReport2006server($qYear,$qMonth,$qYearEnd,$qMonthEnd,$i)->row()->num;
     ...
     $data['page']="analysis";  
     $data['subpage']="association";  
     $data['path']="<li>統計報表</li><li  class='break'>&#187;</li><li>11. 上傳學會後分類報表(2006年版) </li>";
     $data['answer']=$ans;
     $data['qYear']=$qYear;
     $data['qMonth']=$qMonth;
     $data['qYearEnd']=$qYearEnd;
     $data['qMonthEnd']=$qMonthEnd;
        $this->load->view('analysis/association',$data);
    }
        public function associationPDF($qYear,$qMonth,$qYearEnd,$qMonthEnd)
    {
        $ans[17]=0;
        for($i=1;$i<=16;$i++){
        $ans[$i]=0;
    ...
    if( $qYear!='' &&  $qMonth!=''){
     ...
     $data['qYearEnd']=$qYearEnd;
     $data['qMonthEnd']=$qMonthEnd;
     $this->load->view('analysis/associationPDF',$data);
    }

public function association2019()
    {
          $ans[20]=0;
        for($i=1;$i<=20;$i++){
        $ans[$i]=0;
     ...
     if( $qYear!='' &&  $qMonth!=''){
         for($i=1;$i<=20;$i++){
        $ans[$i]=$this->Analysis_Model->query_associateReport2019($qYear,$qMonth,$qYearEnd,$qMonthEnd,$i)->row()->num;
         
        }
         $access_id=accessLog('R','ANALYSIS',$this->session->userdata('userID'),$this->session->userdata('userRealname').'列印PDF報表【 學會分類報表2019版本】(期間:'.$qYear.'/'.$qMonth.'~'.$qYearEnd.'/'.$qMonthEnd.')','S');
        
     }
     $data['page']="analysis";  
     $data['subpage']="association2019";  
     $data['path']="<li>統計報表</li><li  class='break'>&#187;</li><li>11. 上傳學會後分類報表(2006年版) </li>";
     $data['answer']=$ans;
     $data['qYear']=$qYear;
     $data['qMonth']=$qMonth;
     $data['qYearEnd']=$qYearEnd;
     $data['qMonthEnd']=$qMonthEnd;
        $this->load->view('analysis/association2019',$data);
    }
public function association2019Server()
    {
          $ans[20]=0;
        for($i=1;$i<=20;$i++){
        $ans[$i]=0;
     ...
     if( $qYear!='' &&  $qMonth!=''){
         for($i=1;$i<=20;$i++){
        $ans[$i]=$this->Analysis_Model->query_associateReport2019server($qYear,$qMonth,$qYearEnd,$qMonthEnd,$i)->row()->num;
     ...
     $data['page']="analysis";  
     $data['subpage']="association2019Server";  
     $data['path']="<li>統計報表</li><li  class='break'>&#187;</li><li>11. 上傳學會後分類報表(2006年版) </li>";
     $data['answer']=$ans;
     $data['qYear']=$qYear;
     $data['qMonth']=$qMonth;
     $data['qYearEnd']=$qYearEnd;
     $data['qMonthEnd']=$qMonthEnd;
        $this->load->view('analysis/association2019Server',$data);
    }

public function association2019ServerPDF($qYear,$qMonth,$qYearEnd,$qMonthEnd)
    {
          $ans[20]=0;
        for($i=1;$i<=20;$i++){
        $ans[$i]=0;
     ...
     $data['qYearEnd']=$qYearEnd;
     $data['qMonthEnd']=$qMonthEnd;
        $this->load->view('analysis/association2019PDF',$data);
    }
    
    
    public function association2019PDF($qYear,$qMonth,$qYearEnd,$qMonthEnd)
    {
          $ans[20]=0;
        for($i=1;$i<=20;$i++){
        $ans[$i]=0;
