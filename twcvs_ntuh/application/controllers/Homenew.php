                 ...
                 if ($query->num_rows() ==1)
                    {
                      ...
                      //  $this->session->set_userdata('adminID', $adminID);
                        ...
                        $this->session->set_userdata('hospital', $hospital->row()->hospitalName);
                        ...
                        $this->session->set_userdata('SP1', $setting->sp1);
                        $this->session->set_userdata('SP2', $setting->sp2);
                        $this->session->set_userdata('SP3', $setting->sp3);
                        $this->session->set_userdata('SP4', $setting->sp4);
                        $this->session->set_userdata('SP5', $setting->sp5);
                        
                        $permission=$this->Setting_Model->query_permission(intval($this->config->item("hospitalID")))->row();
                        $this->session->set_userdata('P1', $permission->p1);
                        $this->session->set_userdata('P2', $permission->p2);
                        $this->session->set_userdata('P3', $permission->p3);
                        $this->session->set_userdata('P4', $permission->p4);
                        $this->session->set_userdata('P5', $permission->p5);
                        $this->session->set_userdata('VersionNo', $permission->versionnumber);
