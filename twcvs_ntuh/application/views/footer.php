<div class="footer">
        <div class="split">&#169; Copyright 2017 版權所有&nbsp;&nbsp;     
            ...
            &nbsp;&nbsp; 
            版本資訊: <a class="footerVersion" data-fancybox-type="iframe"  href="https://www.twcvs.org.tw/version/index/<?php echo $this->session->userdata('VersionNo');?>" target="_blank"><?php echo $this->session->userdata('VersionNo');?></a>
            </div> 
