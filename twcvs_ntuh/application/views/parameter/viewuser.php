                    ...
                    <form action="<?php echo base_url(); ?>parameter/updateUser" method="post">
                      ...
                      <div class="line">
                        ...
                        <div class="line">
                         ...
                         <div class="line">
                            <label>匯出版本&nbsp;</label>
                             <label for="exportVersion1">完整版</label>  &nbsp;
                             <input type="checkbox"  name="exportVersion1" id="exportVersion1"  value="Y" <?php if($userDetail->exportVersion1=='Y') echo "checked";?>>
                         </div>
                         <div class="line">
                            <label>&nbsp;</label>
                            <label for="exportVersion2">精簡版</label> &nbsp;
                             <input type="checkbox" name="exportVersion2" id="exportVersion2"  value="Y" <?php if($userDetail->exportVersion2=='Y') echo "checked";?>>
                          </div>
                         <div class="line">
                            <label>&nbsp;</label>
                             <label for="exportVersion3">手術內容版本</label> &nbsp;
                             <input type="checkbox" name="exportVersion3" id="exportVersion3"  value="Y" <?php if($userDetail->exportVersion3=='Y') echo "checked";?>>
                        </div>
                        <div class="line">
                            <label>&nbsp;</label>
                             <label for="exportVersion4">手術風險版本</label> &nbsp;
                             <input type="checkbox" name="exportVersion4" id="exportVersion4"  value="Y" <?php if($userDetail->exportVersion4=='Y') echo "checked";?>>
                        </div>
                        <div class="line">
                            <label>&nbsp;</label>
                             <label for="exportVersion5">匿名完整版</label> &nbsp;
                             <input type="checkbox" name="exportVersion5" id="exportVersion5"  value="Y" <?php if($userDetail->exportVersion5=='Y') echo "checked";?>>
                        </div>
