                     ...
                     <div class="line">
                           <label> </label>
                            ...
                            <label for="operationAorticValve_TAVI" id="operationAorticValve_TAVI_Lalbel"></label>
                             <input type="checkbox" name="operationAorticValve_TAVI" id="operationAorticValve_TAVI"  value="Y" <?php if($c->operationAorticValve_TAVI=='Y') echo "checked";?>  onclick="confirmVPVR('1','2');"> 
                           
                              <select name="operationAorticValve_TAVI_S1" id="operationAorticValve_TAVI_S1" onchange="chkTAVI();">
                                   <option value=""></option>
                                   ...
                                   <option value="Transcarotid approach"  <?php if($c->operationAorticValve_TAVI_S1=='Transcarotid approach') echo "selected";?>>Transcarotid approach</option>
                                    <option value="Others"  <?php if($c->operationAorticValve_TAVI_S1=='Others') echo "selected";?>>Others</option>
                                      ...
                                      <select name="operationAorticValve_TAVI_S2" id="operationAorticValve_TAVI_S2" onchange="chkTAVI();">
                                   <option value=""></option>
