...
<?php $this->load->view("header");?>
 <script>
    ...
    <?php foreach($Diagnosis->result() as $row){ ?>
        ...
        availableID.push('<?php echo trim($row->pid);?>');
     <?php } ?>
        $( function() {
                ...
                <div class="content" style="width:750px;height:280px;overflow:auto;">
                    <table cellspacing="0" cellpadding="0" border="0" class="sorting" width=100%> 
                        ...
                        <tbody> 
                            ...
                            <tr> 
                                <td style="padding : 2px 8px;line-height : 10px;"><input type="radio" class="checkbox" name="outcomeCheck1" id="outcomeCheck1"  value="Y" onclick="chkAdultDiagnosis('<?php echo $row->code;?>','<?php echo $row->code;?>', '<?php echo $row->subject;?>');"></td>
...
<script>
    function chkAdultDiagnosis(id,code,subject){
     ...
     function confirmAdultDiagnosis(){
        ...
        {
         parent.showAdultDiagnosis($("#diagnosis_w").val(),$("#diagnosis_id").val(),$("#diagnosis_cat").val(),$("#diagnosis_sub").val());
