                 ...
                 <div class="linewithoutindention">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="sorting" width=100%> 
                        ...
                        <tbody> 
                          ...
                          <tr> 
                                <td>1</th>
                                <td><a class="various" data-fancybox-type="iframe" href="/Analysis/VascularDetail/1/<?php echo $qYear;?>/<?php echo $qMonth;?>/<?php echo $qYearEnd;?>/<?php echo $qMonthEnd;?>">Surgery for great vessel disease</a>
                                    </td>
                               <td><?php echo $a1;?></td>
                            </tr> 
                         <tr> 
