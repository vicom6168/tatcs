...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, $this->session->userdata('hospital').'學會報表','Date From:  '.$qYear. "/".$qMonth."   To  ".$qYearEnd. "/".$qMonthEnd);
...
$html.=' <br/><br/><br/><br/>';
$html.= $this->session->userdata('hospital').': _______________________________(主任簽章)';            
