    ...
    <div class="section">
        <div class="full">
            <div class="box">
                ...
                <div class="content">
                     <a href="/Analysis/chdListEXCEL/<?php echo $i;?>/<?php echo $j;?>/<?php echo $qYear;?>/<?php echo $qMonth;?>/<?php echo $qYearEnd;?>/<?php echo $qMonthEnd;?>"><button  class="blue medium"   style="vertical-align: bottom;"><span>EXCEL</span></button> </a> 
