...
<?php $this->load->view("menu");?>
    ...
    <div class="section">
        <div class="big">
            <div class="box">
                <div class="title">
                    <h2>11. 上傳學會後分類報表(2006年版) </h2>
                    
                </div>
                  <form action="<?php echo base_url(); ?>analysis/association" method="post">
                <div class="content">
                            ...
                            <tr> 
                              ...
                              <tr> 
                               ...
                               <td><?php echo $answer[5];?></th>
                                ...
                                <td>14</th>
                                <td>TAA </th>
                                <td>vascular special sheet 1-02 Thoracic endovascular <br/>aortic aneurysm repair (TEVAR) 的數字</th>
                               <td><?php echo $answer[7];?></th>
                            </tr>     
                                <tr> 
                                <td>15</th>
                                <td>AAA </th>
                                <td>vascular special sheet 1-01 Endovascular <br/>aortic aneurysm repair (EVAR) 的數字</th>
                ...
                <?php if($qYear!="" && $qMonth!="" && $qYearEnd!="" && $qMonthEnd!="") { ?>
                  <div class="line">
                 <button type="submit" class="greenmediumspecial" onclick=" window.open('<?php echo base_url(); ?>analysis/associationPDF/<?php echo $qYear;?>/<?php echo $qMonth;?>/<?php echo $qYearEnd;?>/<?php echo $qMonthEnd;?>','_blank')"><span>PDF</span></button>
                  </div>
                  <?php } ?>
