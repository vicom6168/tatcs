...
class Hospital_Model extends CI_Model {
	...
	function query_hospitalList($type="0"){
		$sql= "SELECT hospitalName FROM hospital   where isDeleted='N'  ";
		if($type!="0")
        {
            $sql.= " and hospitalLevel='$type'";
        } 
		$sql.= "  order by hospitalOrder asc ";
	...
	function save_news($hospitalClass){
   ...
   return  $insert_id;
    ...
    function update_news($nID,$hospitalClass){
