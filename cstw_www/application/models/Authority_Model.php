...
class Authority_Model extends CI_Model {
	...
	function query_authoritybyvs($vsid){
      ...
      function query_authorityEmailbyvs($vsid){
        $sql= "SELECT distinct user.vsEmail as email FROM userauthority ,user  where vsid=?  and userauthority.uid=userID and a_status='1'";
