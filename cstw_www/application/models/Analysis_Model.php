...
function query_vsoperationList($qYear,$qMonth,$qYearEnd,$qMonthEnd,$s, $t){
     ...
     $dEnd=$qYearEnd."-".$qMonthEnd."-01";
      ...
      if($t=="V" && $s!=""){
          ...
          $sql.= " and (patientSurgeon_id3='$s' or patientSurgeon_id4='$s' )";
      } else if( $s!=""){
          $sql.= " and (patientSurgeon_id='$s' or patientSurgeon_id2='$s' or patientSurgeon_id3='$s' or patientSurgeon_id4='$s' )";
      }
        $sql.= " order by patientOpDate";
    return $this->db->query($sql);
    }
    
    function query_complication($qYear,$qMonth,$qYearEnd,$qMonthEnd,$t,$h){
         $d=$qYear."-".$qMonth."-01";
       $dEnd=$qYearEnd."-".$qMonthEnd."-01";
       $conStr="";
       switch($t){
...
$sql.= " ) a ";
  ...
  function query_registernumber($y,$m,$yEnd,$mEnd,$t,$h){
         ...
         $d2=$yEnd."-".$mEnd."-01";
         $sql= " SELECT * from ( ";
         $sql.= "SELECT '台大醫院' as hospital,count(*)  as num FROM cstw_ntuh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";

         $sql.= " UNION ";
         $sql.= " SELECT '三軍總醫院' as hospital,count(*)  as num FROM cstw_tsgh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
             
         $sql.= " UNION ";
         $sql.= " SELECT '馬偕紀念醫院' as hospital,count(*)  as num FROM cstw_mmh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
  
        $sql.= " UNION ";
        $sql.= " SELECT '成大醫院' as hospital,count(*)  as num FROM cstw_nckuh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
        
        $sql.= " UNION ";
        $sql.= " SELECT '衛生福利部桃園醫院' as hospital,count(*)  as num FROM cstw_tygh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
 
        $sql.= " UNION ";
        $sql.= " SELECT '萬芳醫院' as hospital,count(*)  as num FROM cstw_wanfang.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
        
        $sql.= " UNION ";
        $sql.= " SELECT '私立中山醫學大學附屬醫院' as hospital,count(*)  as num FROM cstw_csmuh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
        
        $sql.= " UNION ";
        $sql.= " SELECT '林口長庚醫院' as hospital,count(*)  as num FROM cstw_lkcgmh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
  
       $sql.= " UNION ";
       $sql.= " SELECT '台大新竹分院' as hospital,count(*)  as num FROM cstw_ntuhhch.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";

      $sql.= " UNION ";
      $sql.= " SELECT '臺北榮民總醫院' as hospital,count(*)  as num FROM cstw_vghtpe.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
      
      $sql.= " UNION ";
      $sql.= " SELECT '高雄醫學大學附設醫院' as hospital,count(*)  as num FROM cstw_kmuh.patientinformation t1 where isDeleted='N' and patientOpDate>='$d1' and patientOpDate<='$d2' ";
