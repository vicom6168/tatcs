        ...
        <div class="full">
            <div class="box"  id="divPatientProfiles">
                ...
                <div class="title">
                    ...
                    <form action="<?php echo base_url(); ?>specialSheet/saveVascularPatient" method="post" id="addPatient">
                        ...
                        <div class="line">
                            ...
                            <input type="hidden" name="patientAgeUnit" id="patientAgeUnit" class="smallDisabled" readonly  value="" />
                             <input type="text" name="patientAgeDescription" id="patientAgeDescription" class="small"   value="" />
                        </div>
                         ...
                         <div class="line">
                          ...
                          <div class="line">
                            ...
                            <label>Primary Procedure </label>
                             ...
                             <input type="text" name="patientProcedure1" id="patientProcedure1" class="big" value="" readonly />
                             <input type="hidden" name="patientProcedure_id1" id="patientProcedure_id1" class="small" value="" />
                            ...
                            <label>Secondary Procedure 1</label>
                             ...
                             <input type="text" name="patientProcedure2" id="patientProcedure2" class="big" value="" readonly />
                             <input type="hidden" name="patientProcedure_id2" id="patientProcedure_id2" class="small" value="" />
                            ...
                            <label>Secondary Procedure 2</label>
                             ...
                             <input type="text" name="patientProcedure3" id="patientProcedure3" class="big" value="" readonly />
                             <input type="hidden" name="patientProcedure_id3" id="patientProcedure_id3" class="small" value="" />
                            ...
                            <label>Secondary Procedure 3</label>
                             ...
                             <input type="text" name="patientProcedure4" id="patientProcedure4" class="big" value="" readonly />
                             <input type="hidden" name="patientProcedure_id4" id="patientProcedure_id4" class="small" value="" />
                            ...
                            <label>Secondary Procedure 4</label>
                             ...
                             <input type="text" name="patientProcedure5" id="patientProcedure5" class="big" value="" readonly/>
                             <input type="hidden" name="patientProcedure_id5" id="patientProcedure_id5" class="small" value="" />
                           ...
                           <textarea name="patientProcedureOthers" class="textarea" cols="55" rows="10"></textarea>
                        </div>
                      <div class="line">
                            <label>Diagnosis: </label>
                           <textarea name="patientDiagnosis" class="textarea" cols="55" rows="10"></textarea>
                        </div>
                      <div class="line">
                            <label>備註: </label>
                           <textarea name="vascularMemo" class="textarea" cols="55" rows="10"></textarea>
                        </div>
