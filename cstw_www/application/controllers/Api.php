         ...
         $query = $this->PatientInformation_Model->viewRecordByChart($this->input->post('patientChartNumber'),$this->input->post('patientOpDate')); 
               ...
               $pid=$patientinformationClass->patientID;
                ...
                $patientinformationClass->patientGender=$this->input->post('patientGender');
                 $patientinformationClass->patientSurgeon="";
                $patientinformationClass->patientSurgeon2="";
                ...
                $patientinformationClass->patientSurgeon_id="";
                $patientinformationClass->patientSurgeon_id2="";
                ...
                $patientinformationClass->patientSurgeon_associalid="";
               $patientinformationClass->patientSurgeon_associalid2="";
