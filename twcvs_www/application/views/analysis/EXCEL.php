...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B15', "分類8.Aortic Aneurysm \n thoracic aorta:true")
            ->setCellValue('B16', "分類8.Aortic Aneurysm \n abdominal aorta :true")
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('C1', 'No.')
            ->setCellValue('C2',$answer[1] )
            ->setCellValue('C3', $answer[2])
            ->setCellValue('C4', $answer[3])
            ->setCellValue('C5', $answer[4])
            ->setCellValue('C6', $answer[5])
            ->setCellValue('C7', $answer[6])
            ->setCellValue('C8', $answer[7])
            ->setCellValue('C9', $answer[8])
            ->setCellValue('C10',$answer[9] )
            ->setCellValue('C11', $answer[10])
            ->setCellValue('C12',$answer[11] )
            ->setCellValue('C13',$answer[12] )
            ->setCellValue('C14', $answer[13])
            ->setCellValue('C15', $answer[14])
            ->setCellValue('C16', $answer[15])
            ->setCellValue('C17',$answer[16] )
            ->setCellValue('C18', $answer[17]);
