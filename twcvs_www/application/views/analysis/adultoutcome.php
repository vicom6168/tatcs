                        ...
                        <tbody> 
                          <tr> 
                                ...
                                <td>Total adult <br/>open heart <br/>surgery</th>
                                    ...
                                    (<?php echo $ans[0][9];;?>/<?php echo $ans[0][0];?>)</td>
                                  
                                  <?php for($i=0;$i<8;$i++) { ?>
                                <td><label><?php echo ($ans[0][0]==0?"-":round($ans[0][$i+1]*100/$ans[0][0],2));?>%</label> <br/>
                                    (<?php echo $ans[0][$i+1];;?>/<?php echo $ans[0][0];?>)</td>
                                  <?php } ?>
                         ...
                         <tr> 
                                ...
                                <td>Isolated <br/>CAB</th>
                                    ...
                                    (<?php echo $ans[1][9];;?>/<?php echo $ans[1][0];?>)</td>
                                  
                                 <?php for($i=0;$i<8;$i++) { ?>
                                <td><label><?php echo ($ans[1][0]==0?"-":round($ans[1][$i+1]*100/$ans[1][0],2));?>%</label> <br/>
                                    (<?php echo $ans[1][$i+1];?>/<?php echo $ans[1][0];?>)</th>
                                  <?php } ?>
                            </tr> 
                          <tr> 
                                <td>3</th>
                                <td>Isolated <br/>Aortic Valve <br/>Replacement</th>
                                    ...
                                    (<?php echo $ans[2][9];;?>/<?php echo $ans[2][0];?>)</td>
                                  
                                   <?php for($i=0;$i<8;$i++) { ?>
                               <td><label><?php echo ($ans[2][0]==0?"-":round($ans[2][$i+1]*100/$ans[2][0],2));?>%</label> <br/>
                                   (<?php echo $ans[2][$i+1];?>/<?php echo $ans[2][0];?>)</th>
                                  <?php } ?>
                            </tr> 
                             <tr> 
                                <td>4</th>
                                <td>Isolated Mitral <br/>Valve <br/>Replacement</th>
                                    ...
                                    (<?php echo $ans[3][9];;?>/<?php echo $ans[3][0];?>)</td>
                                  
                                  <?php for($i=0;$i<8;$i++) { ?>
                               <td><label><?php echo ($ans[3][0]==0?"-":round($ans[3][$i+1]*100/$ans[3][0],2));?>%</label> <br/>
                                   (<?php echo $ans[3][$i+1];?>/<?php echo $ans[3][0];?>)</th>
                                   <?php } ?>
                            </tr> 
                             <tr> 
                                <td>5</th>
                                <td>Aortic Valve <br/>Replacement + CAB</th>
                                    ...
                                    (<?php echo $ans[4][9];;?>/<?php echo $ans[4][0];?>)</td>
                                  
                                <?php for($i=0;$i<8;$i++) { ?>
                               <td><label><?php echo ($ans[4][0]==0?"-":round($ans[4][$i+1]*100/$ans[4][0],2));?>%</label> <br/>
                                   (<?php echo $ans[4][$i+1];?>/<?php echo $ans[4][0];?>)</th>
                                  <?php } ?>
                            </tr> 
                             <tr> 
                                <td>6</th>
                                <td>Mitral Valve <br/>Replacement + CAB</th>
                                    ...
                                    (<?php echo $ans[5][9];;?>/<?php echo $ans[5][0];?>)</td>
                                  
                                   <?php for($i=0;$i<8;$i++) { ?>
                              <td><label><?php echo ($ans[5][0]==0?"-":round($ans[5][$i+1]*100/$ans[5][0],2));?>%</label> <br/>
                                  (<?php echo $ans[5][$i+1];?>/<?php echo $ans[5][0];?>)</th>
                                   <?php } ?>
                            </tr> 
                             <tr> 
                                <td>7</th>
                                <td>Aortic + Mitral <br/>Valve Replacements</th>
                                    ...
                                    (<?php echo $ans[6][9];;?>/<?php echo $ans[6][0];?>)</td>
                                  
                                   <?php for($i=0;$i<8;$i++) { ?>
                              <td><label><?php echo ($ans[6][0]==0?"-":round($ans[6][$i+1]*100/$ans[6][0],2));?>%</label> <br/>
                                  (<?php echo $ans[6][$i+1];?>/<?php echo $ans[6][0];?>)</th>
                                   <?php } ?>
                            </tr> 
                             <tr> 
                                <td>8</th>
                                <td>Mitral Valve <br/>Repair</th>
                                    ...
                                    (<?php echo $ans[7][9];;?>/<?php echo $ans[7][0];?>)</td>
                                  
                                 <?php for($i=0;$i<8;$i++) { ?>
                               <td><label><?php echo ($ans[7][0]==0?"-":round($ans[7][$i+1]*100/$ans[7][0],2));?>%</label> <br/>
                                   (<?php echo $ans[7][$i+1];?>/<?php echo $ans[7][0];?>)</th>
                                  <?php } ?>
                            </tr> 
                             <tr> 
                                <td>9</th>
                                <td>Mitral Valve <br/>Repair + CAB</th>
                                    ...
                                    (<?php echo $ans[8][9];;?>/<?php echo $ans[8][0];?>)</td>
                                  
                                <?php for($i=0;$i<8;$i++) { ?>
                              <td><label><?php echo ($ans[8][0]==0?"-":round($ans[8][$i+1]*100/$ans[8][0],2));?>%</label> <br/>
                                  (<?php echo $ans[8][$i+1];?>/<?php echo $ans[8][0];?>)</th>
                                   <?php } ?>
                            </tr> 
                             <tr> 
                                <td>10</th>
                                <td>Aortic surgery<br/>Dissection</th>
                                    ...
                                    (<?php echo $ans[9][9];;?>/<?php echo $ans[9][0];?>)</td>
                                  
                                <?php for($i=0;$i<8;$i++) { ?>
                              <td><label><?php echo ($ans[9][0]==0?"-":round($ans[9][$i+1]*100/$ans[9][0],2));?>%</label> <br/>
                                  (<?php echo $ans[9][$i+1];?>/<?php echo $ans[9][0];?>)</th>
                                   <?php } ?>
                            </tr> 
                             <tr> 
                                <td>11</th>
                                <td>Aortic surgery<br/>Non-dissection</th>
                                    ...
                                    (<?php echo $ans[10][9];;?>/<?php echo $ans[10][0];?>)</td>
                                  
                                <?php for($i=0;$i<8;$i++) { ?>
                              <td><label><?php echo ($ans[10][0]==0?"-":round($ans[10][$i+1]*100/$ans[10][0],2));?>%</label> <br/>
                                  (<?php echo $ans[10][$i+1];?>/<?php echo $ans[10][0];?>)</th>
                                   <?php } ?>
                            </tr> 
                             <tr> 
                                <td>12</th>
                                <td>Not Classiﬁed <br/>Above</th>
                                    ...
                                    (<?php echo $ans[11][9];;?>/<?php echo $ans[11][0];?>)</td>
                                  
                               <?php for($i=0;$i<8;$i++) { ?>
                         <td><label><?php echo ($ans[11][0]==0?"-":round($ans[11][$i+1]*100/$ans[11][0],2));?>%</label> <br/>
                             (<?php echo $ans[11][$i+1];?>/<?php echo $ans[11][0];?>)</th>
