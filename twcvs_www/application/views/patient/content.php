                        ...
                        <tbody> 
                             ...
                             <tr>
                                <td>
                                 <table>
                                     <tr>
                                         <td bgcolor="<?php echo $myColor;?>">Unique ID</td>
                                         <td><?php echo $c->patientHospitalUUID;?></td>
            ...
            <div class="box"  id="divPatientProfiles">
                ...
                <div class="title">
                   ...
                   <!-- <span class="mainmenu"><a href="<?php echo base_url(); ?>patient/printPatient/<?php echo $c->patientID;?>" target="newWindow">Print</a> </span> -->
                    <?php if($this->config->item('hospitalID')!="0") { ?>
                ...
                <div class="title">
                    ...
                    <form action="<?php echo base_url(); ?>patient/patientProfiles" method="post" id="addPatient">
                     
                      <div class="line">
                            <label>Patient ID</label>
                            <input type="text" name="patientSSN" class="big" value="<?php echo $c->patientHospitalUUID;?>" />
                        </div>
...
elseif($c->patientAgeUnit=="2"){
    ...
    echo   "Days";
                        ...
                        <div class="line">
                            ...
                            <input type="text" name="patientHospital" id="patientHospital"  class="small" value="<?php echo $c->patientHospital;?>" >
                                  
                        </div>
                         
                            <div class="line">
                            <label><span style="color:red;">Operation date(必填)</span></label>
                            <input type="text" name="patientOpDate" id="patientOpDate" class="small" value="<?php echo str_replace('0000-00-00', '', $c->patientOpDate);?>" onchange="calAge();calLOS('1',this)" />
                        </div>
                              <div class="line">
                   ...
                   <div class="line">
                            ...
                            <button type="button" class="blue medium" onclick="javascript:callHideShow('divPastHistory');"><span>查看</span></button>
    ...
    echo   "Days";
                ...
                <div class="title">
                   ...
                   <!-- <span class="surgery"><a href="#" onclick="callHideShow('divNoneSurgery')">Non-open heart</a></span> -->
                            ...
                            <label>Diagnosis 1</label>
                             ...
                             <input type="text" name="AdultDiagnosis1" id="AdultDiagnosis1" class="big" value="<?php echo $c->AdultDiagnosis1;?>"" />
                            ...
                            <label>Diagnosis 2</label>
                             ...
                             <input type="text" name="AdultDiagnosis2" id="AdultDiagnosis2" class="big" value="<?php echo $c->AdultDiagnosis2;?>"" />
                            ...
                            <label>Diagnosis 3</label>
                             ...
                             <input type="text" name="AdultDiagnosis3" id="AdultDiagnosis3" class="big" value="<?php echo $c->AdultDiagnosis3;?>"" />
                            ...
                            <label>Diagnosis 4</label>
                             ...
                             <input type="text" name="AdultDiagnosis4" id="AdultDiagnosis4" class="big" value="<?php echo $c->AdultDiagnosis4;?>"" />
                            ...
                            <label>Diagnosis 5</label>
                             ...
                             <input type="text" name="AdultDiagnosis5" id="AdultDiagnosis5" class="big" value="<?php echo $c->AdultDiagnosis5;?>"" />
                          ...
                          <div class="lineheader">
                            <label>CABG:   </label>
                             ...
                             <input type="checkbox" class="checkbox" name="operationCABG" id="operationCABG"  value="Y" <?php if($c->operationCABG=='Y') echo "checked";?> onclick="confirmOperationDetail('operationCABG','Operation_CABG');"> 
                            </div>
                         ...
                         <div class="line">
                          ...
                          <div class="line">
                            <label> Vein graft:</label>
                             ...
                             <div class="line">
                            <label> </label>
                            <label for="operationCardiopulmonaryBypass" id="operationCardiopulmonaryBypassLabel">Cardiopulmonary bypass&nbsp;</label> &nbsp;
                    ...
                    <div class="line">
                          ...
                          <div class="lineheader">
                            ...
                            <label for="operationAorticValve_AVP" id="operationAorticValve_AVP_Lalbel"></label>
                             <input type="checkbox" name="operationAorticValve_AVP" id="operationAorticValve_AVP"  value="Y" <?php if($c->operationAorticValve_AVP=='Y') echo "checked";?>  onclick="confirmVPVR('1','1');"> 
                              ...
                              <select name="operationAVP" id="operationAVP" class="large" onchange="chkAVP();">
                         ...
                         <div class="line">
                            ...
                            <label for="operationAorticValve_AVR" id="operationAorticValve_AVR_Lalbel"></label>
                             <input type="checkbox" name="operationAorticValve_AVR" id="operationAorticValve_AVR"  value="Y" <?php if($c->operationAorticValve_AVR=='Y') echo "checked";?>  onclick="confirmVPVR('1','2');"> 
                              ...
                              <select name="operationAVRSelect" id="operationAVRSelect" onchange="chkAVR();">
                                   <option value=""></option>
                     ...
                     <div class="line">
                         ...
                         <div class="line">
                           ...
                           <input type="checkbox" class="checkbox-indent" name="operationMVPRing" id="operationMVPRing"  value="Y" <?php if($c->operationMVPRing=='Y') echo "checked";?> onclick="chkMVP();"> 
                          </div>
                          <div class="line">
                            <label> </label>
                            ...
                            <input type="checkbox" class="checkbox" name="operationMVPAnnularPlication" id="operationMVPAnnularPlication"  value="Y" <?php if($c->operationMVPAnnularPlication=='Y') echo "checked";?> onclick="chkMVP();"> 
                          </div>
                              <div class="line">
                            <label> </label>
                            <label for="operationMVPLeafletResection"   id="operationMVPLeafletResectionLabel">&nbsp; &nbsp; &nbsp; &nbsp;Leaflet resection &nbsp;</label> &nbsp;
                            <input type="checkbox" class="checkbox" name="operationMVPLeafletResection" id="operationMVPLeafletResection"  value="Y" <?php if($c->operationMVPLeafletResection=='Y') echo "checked";?> onclick="chkMVP();"> 
                          </div>
                             <div class="line">
                            <label> </label>
                            <label for="operationMVPOthers"   id="operationMVPOthersLabel">&nbsp; &nbsp; &nbsp; &nbsp;Others &nbsp;</label> &nbsp;
                            <input type="checkbox" class="checkbox" name="operationMVPOthers" id="operationMVPOthers"  value="Y" <?php if($c->operationMVPOthers=='Y') echo "checked";?> onclick="chkMVP();"> 
                          </div>
                          <div class="line">
                            <label> MVR: </label>
                         ...
                         <div class="line">
                            ...
                            <input type="checkbox" class="checkbox" name="operationMazebiatrialLesion" id="operationMazebiatrialLesion"  value="Y" <?php if($c->operationMazebiatrialLesion=='Y') echo "checked";?>> 
                          </div>
                           <div class="line">
                            <label> </label>
                             <label for="operationMazeLA"  id="operationMazeLALabel">LA Maze (no RA lesion) &nbsp;</label> &nbsp;
                            <input type="checkbox" class="checkbox" name="operationMazeLA" id="operationMazeLA"  value="Y" <?php if($c->operationMazeLA=='Y') echo "checked";?>> 
                          </div>
                          <div class="line">
                            <label> </label>
                             <label for="operationMazePVIwithLAA" id="operationMazePVIwithLAALabel">PVI with LAA closure &nbsp;</label> &nbsp;
                            <input type="checkbox" class="checkbox" name="operationMazePVIwithLAA" id="operationMazePVIwithLAA"  value="Y" <?php if($c->operationMazePVIwithLAA=='Y') echo "checked";?>> 
                          </div>
                           <div class="line">
                            <label> </label>
                             <label for="operationMazePVIwithoutLAA" id="operationMazePVIwithoutLAALabel">PVI without LAA closure &nbsp;</label> &nbsp;
                            <input type="checkbox" class="checkbox" name="operationMazePVIwithoutLAA" id="operationMazePVIwithoutLAA"  value="Y" <?php if($c->operationMazePVIwithoutLAA=='Y') echo "checked";?>> 
                          </div>
                             <div class="line">
                            <label> </label>
                            <label for="operationMazeOthers"  id="operationMazeOthersLabel">Others&nbsp;</label> &nbsp;
                            <input type="checkbox" class="checkbox" name="operationMazeOthers" id="operationMazeOthers"  value="Y" <?php if($c->operationMazeOthers=='Y') echo "checked";?>> 
                          </div>
                         ...
                         <div class="line">
                            ...
                            <input type="checkbox" class="checkbox" name="operationTVPRing" id="operationTVPRing"  value="Y" <?php if($c->operationTVPRing=='Y') echo "checked";?> onclick="chkTVP();"> 
                          </div>
                          <div class="line">
                            <label> </label>
        ...
        <div class="box" id="divCongenitalSurgery">
                ...
                <div class="title">
                 ...
                 <form action="<?php echo base_url(); ?>patient/CongenitalSurgery" method="post">
                          ...
                          <div class="line">
                            <label>Surgeon 2</label>
                          <input type="text" name="patientSurgeon2" id="patientSurgeon2_2"  class="small" value="<?php echo  $c->patientSurgeon2;?>" >
                               
                        </div>
                          <div class="line">
                            <label>Surgeon 3</label>
                          
                              <input type="text" name="patientSurgeon3" id="patientSurgeon2_3"  class="small" value="<?php echo  $c->patientSurgeon3;?>" >
                               
                        </div>
                          <div class="line">
                            <label>Surgeon 4</label>
                          
                               <input type="text" name="patientSurgeon4" id="patientSurgeon2_4"  class="small" value="<?php echo  $c->patientSurgeon4;?>" >
                ...
                <div class="title">
                    ...
                    <span class="surgery">Congenital Surgery</span>
                            ...
                            <label>Diagnosis 1</label>
                             ...
                             <input type="text" name="CongenitalDiagnosis1" id="CongenitalDiagnosis1" class="big" value="<?php echo $c->CongenitalDiagnosis1;?>"" />
                            ...
                            <label>Diagnosis 2</label>
                             ...
                             <input type="text" name="CongenitalDiagnosis2" id="CongenitalDiagnosis2" class="big" value="<?php echo $c->CongenitalDiagnosis2;?>"" />
                            ...
                            <label>Diagnosis 3</label>
                             ...
                             <input type="text" name="CongenitalDiagnosis3" id="CongenitalDiagnosis3" class="big" value="<?php echo $c->CongenitalDiagnosis3;?>"" />
                            ...
                            <label>Diagnosis 4</label>
                             ...
                             <input type="text" name="CongenitalDiagnosis4" id="CongenitalDiagnosis4" class="big" value="<?php echo $c->CongenitalDiagnosis4;?>"" />
                            ...
                            <label>Diagnosis 5</label>
                             ...
                             <input type="text" name="CongenitalDiagnosis5" id="CongenitalDiagnosis5" class="big" value="<?php echo $c->CongenitalDiagnosis5;?>"" />
                         ...
                         <div class="line">
                           ...
                           <div class="line">
                            <label>Primary Procedure </label>
                             ...
                             <input type="text" name="CongenitalProcedure1" id="CongenitalProcedure1" class="big" value="<?php echo $c->CongenitalProcedure1;?>"" />
                            ...
                            <label>Secondary Procedure 1</label>
                             ...
                             <input type="text" name="CongenitalProcedure2" id="CongenitalProcedure2" class="big" value="<?php echo $c->CongenitalProcedure2;?>"" />
                            ...
                            <label>Secondary Procedure 2</label>
                             ...
                             <input type="text" name="CongenitalProcedure3" id="CongenitalProcedure3" class="big" value="<?php echo $c->CongenitalProcedure3;?>"" />
                            ...
                            <label>Secondary Procedure 3</label>
                             ...
                             <input type="text" name="CongenitalProcedure4" id="CongenitalProcedure4" class="big" value="<?php echo $c->CongenitalProcedure4;?>"" />
                            ...
                            <label>Secondary Procedure 4</label>
                             ...
                             <input type="text" name="CongenitalProcedure5" id="CongenitalProcedure5" class="big" value="<?php echo $c->CongenitalProcedure5;?>"" />
                            ...
                            <label for="operationCongenitalBypassCirculatoryTime" id="operationCongenitalBypassCirculatoryTime_Lalbel"></label>
                             ...
                             <div class="line">
                              ...
                              <select name="operationCongenitalBypassCardioplegia" id="operationCongenitalBypassCardioplegia" class="large">
                                   ...
                                   <option  class="large" value="Blood Pregisol"  <?php if($c->operationCongenitalBypassCardioplegia=='Blood Pregisol') echo "selected";?>>Blood Pregisol</option>
                                   <option  class="large" value="Non-blood Pregisol"  <?php if($c->operationCongenitalBypassCardioplegia=='Non-blood Pregisol') echo "selected";?>>Non-blood Pregisol</option>
       ...
       <div class="box" id="divOutcome">
                    ...
                    <h2>Outcome results </h2>
                        ...
                        <div class="line">
                            ...
                            <input type="text" name="patientDischargeDate" id="patientDischargeDate1" class="small" value="<?php echo str_replace('0000-00-00', '', $c->patientDischargeDate);?>"  onchange="javascript:calLOS('2',this);"/>
                              ...
                              <select name="outcomeStatus" id="outcomeStatus" class="large">
                                   <option value="" class="small"></option>
                        ...
                        <tbody> 
                          <tr> 
                             ...
                             <tr> 
                                ...
                                <td>Renal Failure </th>
                                <td>Acute or worsening renal failure resulting in one or more of the 1. Increase of serum creatinine to > 2.0, and 2x most recent preoperative creatinine level. following: 2. A new requirement for dialysis postoperatively.  </td>
                             ...
                             <tr> 
                                ...
                                <td>Prolonged Ventilation > 24 hours </th>
                             ...
                             <tr> 
                                ...
                                <td>Deep Sternal Wound Infection </th>
                                <td>Deep sternal infection, within 30 days postoperatively, involving muscle, bone, and/or mediastinum REQUIRING OPERATIVE INTERVENTION. Must have ALL of the following conditions: 1. Wound opened with excision of tissue (I&D) or re-exploration of mediastinum 2. Positive culture 3. Treatment with antibiotics. </td>
            ...
            <div class="box" id="divChildOutcome">
                <div class="content forms">
                                            ...
                                            <div class="lineheader">
                            <label>Specifycomplication(s)  </label>
                        ...
                        <tbody> 
                          <tr> 
                               ...
                               <td>Arrhythmia requiring electrical cardioversion or defibrillation</td>
                            </tr> 
                            <tr> 
                                ...
                                <td><input type="checkbox" class="checkbox" name="outcomeChildComplication4" id="outcomeChildComplication4"  value="Y" <?php if($c->outcomeChildComplication4=='Y') echo "checked";?>  onclick="checkcomplex('4');checkReopen()"> </td>
                               <td><b style="color:blue">Bleeding, requiring reoperation</b> </td>
                            </tr> 
                              ...
                              <tr> 
                                ...
                                <td>Cardiac dysfunction resulting in low cardiac output </th>
                              ...
                              <tr> 
                               ...
                               <td>Endocarditis­postprocedural infective endocarditis </td>
                            </tr> 
                              <tr> 
                                ...
                                <td><input type="checkbox" class="checkbox" name="outcomeChildComplication10" id="outcomeChildComplication10"  value="Y" <?php if($c->outcomeChildComplication10=='Y') echo "checked";?>  onclick="checkcomplex('10');"> </td>
                               <td><b style="color:blue">Mechanical circulatory support (IABP, VAD, ECMO, or CPS)</b> </td>
                            </tr> 
                              <tr> 
                                ...
                                <td>Multi­System Organ Failure (MSOF) = Multi­Organ Dysfunction Syndrome (MODS) </th>
                               ...
                               <td>Neurological deficit diagnosed in the operating room, persisting at discharge or 91 days if patient is still in hospital. </td>
                            </tr> 
                              <tr> 
                                ...
                                <td><input type="checkbox" class="checkbox" name="outcomeChildComplication14" id="outcomeChildComplication14"  value="Y" <?php if($c->outcomeChildComplication14=='Y') echo "checked";?>   onclick="checkcomplex('14');"> </td>
                               <td><b style="color:blue">Neurological deficit that occurred after the operating room visit, persisting at discharge</b> </td>
                            </tr> 
                              <tr> 
                               ...
                               <td>Paralyzed diaphragm (possible phrenic nerve injury) </td>
                            </tr> 
                              ...
                              <tr> 
                                <td> <input type="checkbox" class="checkbox" name="outcomeChildComplication19" id="outcomeChildComplication19"  value="Y" <?php if($c->outcomeChildComplication19=='Y') echo "checked";?>> </td>
                                <td>Peripheral nerve injury not present at discharge or 91 days if patient is still in hospital </th>
                                <td><input type="checkbox" class="checkbox" name="outcomeChildComplication20" id="outcomeChildComplication20"  value="Y" <?php if($c->outcomeChildComplication20=='Y') echo "checked";?>   onclick="checkcomplex('20');"> </td>
                               <td><b style="color:blue">Postoperative/Postprocedural respiratory insufficiency requiring mechanical ventilatory support > 7 days</b> </td>
                            </tr> 
                              <tr> 
                               ...
                               <td>Pulmonary vein obstruction </td>
                            </tr> 
                              <tr> 
                                <td> <input type="checkbox" class="checkbox" name="outcomeChildComplication23" id="outcomeChildComplication23"  value="Y" <?php if($c->outcomeChildComplication23=='Y') echo "checked";?>   onclick="checkcomplex('23');"> </td>
                                <td><b style="color:blue">Renal failure ­ acute renal failure, Acute renal failure requiring dialysis at the time of hospital discharge or 91 days if patient is still in hospital</b> </th>
                               ...
                               <td>Renal failure ­ acute renal failure, Acute renal failure requiring temporary dialysis with the need for dialysis not present at hospital discharge or 91 days if patient is still in hospital </td>
                            </tr> 
                              <tr> 
                                ...
                                <td>Renal failure ­ acute renal failure, Acute renal failure requiring temporary hemofiltration with the need for dialysis not present at hospital discharge or 91 days if patient is still in hospital </th>
                               ...
                               <td>Respiratory failure, requiring tracheostomy </td>
                            </tr> 
                              <tr> 
                                ...
                                <td>Seizure </th>
                                <td><input type="checkbox" class="checkbox" name="outcomeChildComplication28" id="outcomeChildComplication28"  value="Y" <?php if($c->outcomeChildComplication28=='Y') echo "checked";?>   onclick="checkcomplex('28');"> </td>
                               <td><b style="color:blue">Sepsis </b></td>
                            </tr> 
                              <tr> 
                                ...
                                <td>Sternum left open, unplanned </th>
                              ...
                              <tr> 
                               ...
                               <td>Systemic vein obstruction </td>
                            </tr> 
                            <tr> 
                                <td> <input type="checkbox" class="checkbox" name="outcomeChildComplication33" id="outcomeChildComplication33"  value="Y" <?php if($c->outcomeChildComplication33=='Y') echo "checked";?> onclick="checkReopen();"> </td>
                                <td>Unplanned cardiac reoperation during the postoperative or postprocedural time period, exclusive of reoperation for bleeding </th>
                            ...
                            <tr> 
                                <td> <input type="checkbox" class="checkbox" name="outcomeChildComplication35" id="outcomeChildComplication35"  value="Y" <?php if($c->outcomeChildComplication35=='Y') echo "checked";?>   onclick="checkcomplex('35');"> </td>
                                <td><b style="color:blue">Wound infection­Mediastinitis</b> </th>
                               ...
                               <td>Wound infection­Superficial wound infection </td>
                            </tr> 
                            </tbody>
                            </table>
                            <br/><br/>
...
function chkTVP(){
    if($('#operationTVPRing').is(':checked') || $('#operationTVPArtificialChord').is(':checked') || $('#operationTVPAnnularPlication').is(':checked') || $('#operationTVPLeafletResection').is(':checked') || $('#operationTVPOthers').is(':checked') ){
...
function chkMVP(){
    if($('#operationMVPRing').is(':checked') || $('#operationMVPArtificialChord').is(':checked') || $('#operationMVPAnnularPlication').is(':checked') || $('#operationMVPLeafletResection').is(':checked') || $('#operationMVPOthers').is(':checked') ){
