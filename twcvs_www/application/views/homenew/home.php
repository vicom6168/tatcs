...
<button type="submit" id="LoginButton" >
        ...
        <?php foreach($advertisementList->result() as $row){  ?>
            <li>
                ...
                <a href="/advertisement/goout/<?php echo $row->aid;?>" target="_blank"><img src="/uploads/<?php echo $row->abanner;?>" width="240" height="100" border=0></a>
                  <?php }  else { ?>
                  <a> <img src="/uploads/<?php echo $row->abanner;?>"  alt=""   width="240" height="100"></a>
                <?php } ?>
            </li>
           <?php } ?>
           <?php for($i=$advertisementList->num_rows() ;$i<12;$i++){  ?>
            <li>
                ...
                <a href="#"><img src="<?php echo base_url(); ?>css/images/hairstyle7.jpg" alt="" border=0></a>
