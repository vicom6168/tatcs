                    ...
                    <form action="<?php echo base_url(); ?>evaluation/savePatient" method="post" id="addPatient">
                        ...
                        <div class="line">
                         ...
                         <div class="line">
                             ...
                             <input type="text" name="patientBirthday" id="patientBirthday"  class="small" value=""    onblur="calAge();"  onKeyUp="javascript:checkDate(this);" onBlur="javascript:checkDate_Format(this);" maxlength="10"  />
                        </div>
