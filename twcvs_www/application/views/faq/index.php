...
<?php $this->load->view("menu");?>
    ...
    <div class="section">
        <div class="full">
            <div class="box">
                <div class="number">
                         <button   class="green medium" onclick="javascript: window.location='<?php echo base_url(); ?>faq/addfaq';"  style="vertical-align: bottom;"><span>新增常見問題</span></button>
               </div>
                <div class="content">
                            ...
                            <tr> 
                                ...
                                <td style="padding : 2px 8px;line-height : 10px;">
                                    <a class="various" data-fancybox-type="iframe" href="/faq/viewRecord/<?php echo $row->faqid;?>"> <button  class="blue medium"><span>查看</span></button></a>
                                     <?php if(1==1) { ?>
                                     <button  class="blue medium" onclick="javascript: window.location='<?php echo base_url(); ?>faq/editRecord/<?php echo $row->faqid;?>';" ><span>編輯</span></button>
