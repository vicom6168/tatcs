        ...
        <div class="full">
            <div class="box"  id="divPatientProfiles">
                ...
                <div class="title">
                    ...
                    <form action="<?php echo base_url(); ?>faq/savefaq" method="post">
                      ...
                      <div class="line">
                           ...
                           <div class="line">
                            ...
                            <input type="text" name="faqsubject" class="medium" value="" />
                        </div>  
                        <div class="line">
                            <label style="width:100px;height:500px">Content: </label>
                           <textarea name="faqcontent"  cols="100" rows="100"></textarea>
                        </div>
                          <div class="line">
                            <label style="width:100px">掛序</label>
                            <input type="text" name="faqorder" class="medium" value="" />(請填整數)
                        </div>  
