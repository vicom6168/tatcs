    ...
    <div class="section">
        <div class="full">
            <div class="box">
                ...
                <div class="content">
                        <form action="<?php echo base_url(); ?>exportPatient/exportVascularPatient" method="post">
           ...
           <?php if( $d1!='' &&  $d2!=''){ ?>
             <div class="line">
                 <button type="submit" class="greenmediumspecial" onclick=" window.open('<?php echo base_url(); ?>exportPatient/VascularEXCEL/<?php echo $d1;?>/<?php echo $d2;?>/<?php echo urlencode($h1);?>','_blank')"><span>EXCEL</span></button>
                  </div>
             <?php } ?>
                <br/> </div> </div>
        </div>
