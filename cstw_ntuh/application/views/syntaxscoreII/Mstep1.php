...
$s=$myScore->row();
 ?>
    ...
    <form method="post" action="<?php echo base_url(); ?>syntaxscoreII/Mstep2">            
...
<?php } ?>
<?php if($s->q16=="1") {?>
$('#check_16').prop("checked", true);
clickrow('16');
<?php } ?>
<?php if($s->q16a=="1") {?>
$('#check_16a').prop("checked", true);
clickrow('16a');
<?php } ?>
<?php if($s->q16b=="1") {?>
$('#check_16b').prop("checked", true);
clickrow('16b');
<?php } ?>
<?php if($s->q16c=="1") {?>
$('#check_16c').prop("checked", true);
clickrow('16c');
<?php } ?>
<?php if($s->q5=="1") {?>
...
<?php } ?>
<?php if($s->q12a=="1") {?>
$('#check_12a').prop("checked", true);
clickrow('12a');
<?php } ?>
<?php if($s->q12b=="1") {?>
$('#check_12b').prop("checked", true);
clickrow('12b');
<?php } ?>
<?php if($s->q13=="1") {?>
...
<?php } ?>
<?php if($s->q14a=="1") {?>
$('#check_14a').prop("checked", true);
clickrow('14a');
<?php } ?>
<?php if($s->q14b=="1") {?>
$('#check_14b').prop("checked", true);
clickrow('14b');
<?php } ?>
<?php if($s->q15=="1") {?>
$('#check_15').prop("checked", true);
clickrow('15');
<?php } ?>
</script>
